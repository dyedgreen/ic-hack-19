package com.benny.openlauncher.chatbot;
 ...
 */
public class WhyLogin extends AppCompatActivity implements
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_why_login2);
  ...
  private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
    ...
    ArrayAdapter<String> adapter =
        new ArrayAdapter<>(WhyLogin.this,
  ...
  public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
    ...
    protected Boolean doInBackground(Void... params) {
      ...
      try {
        URL url = new URL("http:/10.0.2.2/api/user/login/android_why_launcher?username=" +
